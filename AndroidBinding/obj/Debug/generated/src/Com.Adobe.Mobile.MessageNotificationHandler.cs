...
namespace Com.Adobe.Mobile {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.adobe.mobile']/class[@name='MessageNotificationHandler']"
	[global::Android.Runtime.Register ("com/adobe/mobile/MessageNotificationHandler", DoNotGenerateAcw=true)]
	public partial class MessageNotificationHandler : global::Android.Content.BroadcastReceiver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/adobe/mobile/MessageNotificationHandler", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (MessageNotificationHandler); }
		}

		protected MessageNotificationHandler (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.adobe.mobile']/class[@name='MessageNotificationHandler']/constructor[@name='MessageNotificationHandler' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public MessageNotificationHandler () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (MessageNotificationHandler)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Adobe.Mobile.MessageNotificationHandler __this = global::Java.Lang.Object.GetObject<global::Com.Adobe.Mobile.MessageNotificationHandler> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.adobe.mobile']/class[@name='MessageNotificationHandler']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
